...
const styles = StyleSheet.create({
  ...
  cardLabel: { fontSize: 9, letterSpacing: 1.8, textTransform: 'uppercase', color: '#B09A7E', fontWeight: '600' },
  ...
  irisLabel: { fontSize: 9, letterSpacing: 1.8, textTransform: 'uppercase', color: '#9B6B9B', fontWeight: '600' },
  irisTitle: { fontSize: 19, color: '#1A1A2E', fontStyle: 'italic', fontWeight: '600', lineHeight: 24 },
  ...
  pollResultLabel: { fontSize: 13, color: '#3A2C28' },
  ...
  monthlyLabel: { fontSize: 9, letterSpacing: 2, textTransform: 'uppercase', fontWeight: '600', color: '#C4A882', marginBottom: spacing.sm },
  ...
  monthlyTitle: { fontSize: 28, color: '#FDFAF6', fontStyle: 'italic', fontWeight: '700', lineHeight: 34, marginBottom: spacing.sm },
