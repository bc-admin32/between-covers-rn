...
const styles = StyleSheet.create({
  ...
  bubbleName: { fontSize: 12, fontFamily: 'Nunito_700Bold', color: '#B83255' },
  irisBubbleName: { color: '#9B6B9B' },
  youLabel: { color: '#C4A882', fontFamily: 'Nunito_400Regular' },
  bubbleTime: { fontSize: 11, color: '#C4A882', fontFamily: 'Nunito_400Regular' },
  editedLabel: { fontSize: 10, color: '#C4A882', fontFamily: 'Nunito_400Regular_Italic' },
  bubbleBody: { fontSize: 14, color: '#3A2C28', lineHeight: 21, fontFamily: 'Nunito_400Regular' },
